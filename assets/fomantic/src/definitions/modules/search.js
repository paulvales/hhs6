...
$.fn.search.settings = {
  ...
  error : {
    ...
    noNormalize     : '"ignoreDiacritics" setting will be ignored. Browser does not support SyonixString().normalize(). You may consider including <https://cdn.jsdelivr.net/npm/unorm@1.4.1/lib/unorm.min.js> as a polyfill.'
  },
